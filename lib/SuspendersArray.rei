...
let slice: (array('a), int, int) => array('a);
let sliceToEnd: (array('a), int) => array('a);
let fill: (array('a), int, int, 'a) => unit;
let forEach: (array('a), 'a => 'b) => unit;
let forEachi: (array('a), (int, 'a) => 'b) => unit;
let getBy: (array('a), 'a => bool) => option('a);
let getIndexBy: (array('a), 'a => bool) => option(int);
let keep: (array('a), 'a => bool) => array('a);
let keepi: (array('a), (int, 'a) => bool) => array('a);
let keepMap: (array('a), 'a => option('a)) => array('a);
let reduce: (array('a), 'b, ('b, 'a) => 'b) => 'b;
let reduceReverse: (array('a), 'b, ('b, 'a) => 'b) => 'b;
let reducei: (array('a), 'b, (int, 'b, 'a) => 'b) => 'b;
let every: (array('a), 'a => bool) => bool;
let some: (array('a), 'a => bool) => bool;
let eq: (array('a), array('b), ('a, 'b) => bool) => bool;
let cmp: (array('a), array('b), ('a, 'b) => int) => int;
